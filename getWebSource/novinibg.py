...
mycursor.execute("SELECT title FROM dnesbg WHERE site = 'novini.bg' ORDER BY id DESC LIMIT 1000")
...
for x in range(len(getRealNews)):
    ...
    val = (getRealNews[x], " ", getRealNewsLink[x], getRealNewsImg[x], "novini.bg", time)
